...
class ScanningApp:
    def __init__(self, root, rel1, rel2, w_size):
        ...
        self.connect_scanner_button = tk.Button(root, text="Connect\nScanner", command=self.connect_scanner, height=2, font=("Helvetica", self.font_size))
        ...
        self.fetch_button = tk.Button(root, text="Get Preview", command=self.fetch_preview, state="disabled", font=("Helvetica", self.font_size))
        ...
        tk.Label(root, text="Set Resolution", font=("Helvetica", self.font_size)).grid(row=2, column=1, pady=0, sticky=tk.W)
        ...
        tk.Label(root, text="Top Left \t\tx", font=("Helvetica", self.font_size)).grid(row=4, column=1, pady=5, sticky=tk.W)
        self.tl_x_entry = tk.Entry(root, textvariable=self.tl_x_var, width=5, state="disabled", font=("Helvetica", self.font_size))
        ...
        tk.Label(root, text="y", anchor=tk.W, font=("Helvetica", self.font_size)).grid(row=4, column=3, pady=5, sticky=tk.E)
        self.tl_y_entry = tk.Entry(root, textvariable=self.tl_y_var, width=5, state="disabled", font=("Helvetica", self.font_size))
        ...
        tk.Label(root, text="Bottom Right \tx", font=("Helvetica", self.font_size)).grid(row=5, column=1, pady=5, sticky=tk.W)
        self.br_x_entry = tk.Entry(root, textvariable=self.br_x_var, width=5, state="disabled", font=("Helvetica", self.font_size))
        ...
        tk.Label(root, text="y", anchor=tk.W, font=("Helvetica", self.font_size)).grid(row=5, column=3, pady=5, sticky=tk.E)
        self.br_y_entry = tk.Entry(root, textvariable=self.br_y_var, width=5, state="disabled", font=("Helvetica", self.font_size))
        ...
        self.file_save_entry = tk.Entry(root, textvariable=self.file_save_var, width=19, state="disabled", font=("Helvetica", self.font_size))
        self.file_save_entry.grid(row=6, column=2, pady=5, columnspan=2, sticky=tk.W)
        tk.Button(root, text="Browse", command=self.browse_file_save_location, font=("Helvetica", self.font_size)).grid(row=6, column=4, pady=5,
                                                                                    sticky=tk.W)
        ...
        self.file_name_field = tk.Entry(root, textvariable=self.file_name_var, width=19, state="disabled", font=("Helvetica", self.font_size))
        ...
        self.scan_button = tk.Button(root, text="Scan\nNow", command=self.scan_now, width=6, height=2, state="disabled", font=("Helvetica", self.font_size))
        ...
        #                                                                                          pady=10, sticky=tk.W)
        tk.Button(root, text="Perform\nML", command=self.next_stage, height=2, state="normal", font=("Helvetica", self.font_size)).grid(row=9, column=4,
                                                                                                        pady=10,
                                                                                                        sticky=tk.W)

        # 9. Button for Quit Scanner
        tk.Button(root, text="Back", command=self.quit_scanner, height=2, font=("Helvetica", self.font_size)).grid(row=9, column=1, pady=10,
                                                                                        sticky=tk.W)
    ...
    def browse_file_save_location(self):
        directory = filedialog.askdirectory(initialdir="./"+str(self.resources)+'/', title="Select File Save Directory")
        if directory:
    ...
    def fetch_preview(self):
        ...
        try:
            ...
            self.img_pil.save("preview.jpg", quality=88)
    ...
    def scan_now(self):
        ...
        try:
            ...
            self.img_scan.save(self.file_save_var.get() + str(self.file_name_var.get()) + str(self.file_format_var.get()),
                               quality=85)
            self.last_scanned_add = self.file_save_var.get() + str(self.file_name_var.get()) + str(self.file_format_var.get())
            ...
            self.log_text.insert(tk.END, "\n\tFile saved at: {}\n\tFile saved as: {}".format(self.file_save_var.get(), self.file_name_var.get()+self.file_format_var.get()))
