...
#     data = pd.read_csv("../resources/V3_LD_Hexaboard_Co-ordinates_v3.xlsx - Co-ordinates_modified_origin.csv")
#     real_x = np.array(data.iloc[:, 4])
#     real_y = np.array(data.iloc[:, 5])
#     names = np.array(data.iloc[:, 6])
#     print(real_x, real_y, names)
